...
public class Girls_Lodge_Default_Item_Frag extends Fragment {
    ...
    String bed;
    public Girls_Lodge_Default_Item_Frag() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.fragment_girls_lodge_default_item, container, false);
    ...
    public void retriveData() {
        ...
        StringRequest stringRequest = new StringRequest(Request.Method.POST, url, new Response.Listener<String>() {
            ...
            protected Map<String, String> getParams() throws AuthFailureError {
                ...
                param.put("lodge_type","Girls Lodge");
                return param;
            }
        };
